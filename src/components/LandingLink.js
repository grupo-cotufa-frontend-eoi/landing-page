...
.rockets-container:hover .title-about {
  color: black;
  font-weight: 600;
  text-transform: uppercase;
}

.rockets-container:hover {
  opacity: 1;
}
...
customElements.define("landing-link", LandingLink);
